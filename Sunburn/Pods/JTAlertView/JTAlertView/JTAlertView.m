...
const static CGFloat kBtnFontSize = 16.0;
const static CGFloat kTitleFontSize = 16.0;
...
- (void)addButtonWithTitle:(NSString *)titleText font:(UIFont *)font style:(JTAlertViewStyle)style forControlEvents:(UIControlEvents)controlEvents action:(void (^)(JTAlertView *alertView))action {
    ...
    [btn setBackgroundColor:[UIColor colorWithRed:28.0/255.0 green:38.0/255.0 blue:48.0/255.0 alpha:1.0]];
...
- (void)addSeparatorInView:(UIView *)superview withTag:(NSInteger)tag andFrame:(CGRect)frame {
    ...
    separator.backgroundColor = [UIColor colorWithWhite:kSeparatorColorValue alpha:0.12];
    separator.tag = tag;
